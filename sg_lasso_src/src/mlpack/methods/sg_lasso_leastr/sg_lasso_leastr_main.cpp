...
//    "used:"
//    "\n\n" +
//    PRINT_CALL("sg_lasso_leastr", "input_model", "lr_model", "test", "X_test",
//        "output_predictions", "X_test_responses"),
    ...
    SEE_ALSO("mlpack::regression::SGLassoLeastR C++ class documentation",
        "@doxygen/classmlpack_1_1regression_1_1SGLassoLeastR.html"));
...
PARAM_MODEL_OUT(SGLassoLeastR, "feature_weights", "File of learned feature weights.", "weights");
...
//	std::cout << "processFasta exit status: " << testVal << std::endl;
    ...
    sgl = new SGLassoLeastR(features, responses, opts_ind, lambda, processFasta(fastaFileName));
    Timer::Stop("sparse_group_lasso");
  }


  // Save the model if needed.
  //CLI::GetParam<SGLassoLeastR*>("feature_weights") = sgl;
  CLI::GetParam<SGLassoLeastR*>("feature_weights") = sgl;
}
