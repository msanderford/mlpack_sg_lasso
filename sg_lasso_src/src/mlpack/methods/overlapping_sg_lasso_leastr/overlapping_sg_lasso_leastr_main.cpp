...
//        "output_predictions", "X_test_responses"),
    ...
    SEE_ALSO("mlpack::regression::OLSGLassoLeastR C++ class documentation",
        "@doxygen/classmlpack_1_1regression_1_1OLSGLassoLeastR.html"));
...
PARAM_ROW_IN("field", "Vector of feature indices for overlapping groups.", "g");
...
static void mlpackMain()
{
  ...
  if (computeModel)
  {
    ...
    Timer::Start("load_field");
    field = std::move(CLI::GetParam<rowvec>("field"));
  ...
  CLI::GetParam<OLSGLassoLeastR*>("feature_weights") = sgl;
